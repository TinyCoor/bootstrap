...
bool array_type::on_initialize(result &r, compiler::program* program)
{
    ...
    auto flags_identifier = program->make_identifier(block_scope, "flags", nullptr);
    ...
    auto element_type_identifier = program->make_identifier(block_scope, "element_type", nullptr);
