...
#ifndef NTRINICS_ADDRESS_OF_INTRINSIC_H_
#define NTRINICS_ADDRESS_OF_INTRINSIC_H_
#include "intrinsic.h"
namespace gfx::compiler {
class address_of_intrinsic : public  intrinsic {
public:
    address_of_intrinsic(compiler::module* module, compiler::block* parent_scope,
...
#endif //NTRINICS_ADDRESS_OF_INTRINSIC_H_
