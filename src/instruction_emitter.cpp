	...
	uint8_t rhs_index)
{
	...
	add_op.operands[0].type = operand_types::register_integer;
...
void instruction_emitter::load_stack_offset_to_register(op_sizes size ,uint8_t target_index, uint64_t offset)
{
...
void instruction_emitter::store_register_to_stack_offset(op_sizes size ,uint8_t source_index, uint64_t offset)
{
...
void instruction_emitter::load_with_offset_to_register(op_sizes size ,uint8_t source_index,
	uint8_t target_index,uint64_t offset)
{
	instruction_t load_op;
	load_op.op = op_codes::load;
	load_op.size = size;
...
void instruction_emitter::store_with_offset_from_register(op_sizes size ,uint8_t source_index,
	uint8_t target_index, uint64_t offset)
{
	instruction_t store_op;
	store_op.op = op_codes::store;
